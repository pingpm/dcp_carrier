...
const agreements = {
  terms: {
    title: "承运商注册协议",
    summary: "本协议适用于承运商通过平台入驻认证、维护线路、确认订单、履约运输、充值钱包和查看流水。",
    sections: [
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "您选择大板运输后，可维护大板线路；选择小板运输后，可维护小板线路。代驾能力为保留字段，本期不展示、不开放业务功能。",
  ...
  privacy: {
    title: "承运商隐私协议",
    summary: "本协议说明平台在承运商端收集、使用和保护企业资质、线路、钱包、订单履约和联系人信息的方式。",
    sections: [
      {
        heading: "一、我们收集的信息",
        paragraphs: [
